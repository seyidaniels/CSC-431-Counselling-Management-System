            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    include("config.php");
                        ...
                        $sql="SELECT r.STUD_ID, r.STUD_NO, CONCAT(r.STUD_FNAME,' ', r.STUD_LNAME) AS FULLNAME,r.Stud_YEAR_LEVEL,r.STUD_SECTION,
                                        CONCAT(r.STUD_COURSE,' ',r.Stud_YEAR_LEVEL,'-',r.STUD_SECTION) AS COURSE,
                                        r.Stud_CITY_ADDRESS,r.Stud_MOBILE_NO,r.STUD_EMAIL
                                        FROM r_stud_profile AS r
                                        where r.stud_no = '$stud_no' 
                                        OR CONCAT(r.STUD_FNAME,' ', r.STUD_LNAME)='$stud_name'";

                        /*"SELECT r.STUD_ID, r.STUD_NO, CONCAT(r.STUD_FNAME,' ', r.STUD_LNAME) AS FULLNAME,r.Stud_YEAR_LEVEL,r.STUD_SECTION,
                                        CONCAT(r.STUD_COURSE,' ',r.Stud_YEAR_LEVEL,'-',r.STUD_SECTION) AS COURSE,
                                        r.Stud_CITY_ADDRESS,r.Stud_MOBILE_NO,r.STUD_EMAIL, t.STUD_ID, t.Couns_CODE, t.COUNS_APPROACH, t.COUNS_DATE,
                    ...
                    ?>
                            ...
                            <h5 id="C_stud_cno" name="C_stud_cno"><?php echo''.$row['Stud_MOBILE_NO'].''?></h4>
                            <h5 id="C_stud_email" name="C_stud_email"><?php echo''.$row['STUD_EMAIL'].''?></h4>
                            <h5 id="C_stud_add" name="C_stud_add"><?php echo''.$row['Stud_CITY_ADDRESS'].''?></h4>
                            </div>
                            <div class="col-md-6">
                                <blockquote>
                    ...
                    /*include("config.php");
                        ...
                        $sql2="SELECT r.STUD_ID, r.STUD_NO, CONCAT(r.STUD_FNAME,' ', r.STUD_LNAME) AS FULLNAME, t.STUD_ID, t.Couns_CODE, 
                    ...
                    ?>
                            ...
                            <div class="col-md-6">
                                <blockquote>
                                    <button class="btn btn-success"   data-toggle="modal" href="#myModal<?php echo ''.$row['STUD_ID'].''; ?>" />
                                     <i class="fa fa-eye"> More Profile details</i></button>
                                    <button class="btn btn-success"   data-toggle="modal" href="#myModalC<?php echo ''.$row['STUD_ID'].''; ?>" />
                    ...
                    include("config.php");
                        ...
                        $sql="SELECT `STUD_ID`, `STUD_NO`, CONCAT(`STUD_FNAME`,' ', `STUD_LNAME`) AS FULLNAME,`Stud_YEAR_LEVEL`,`STUD_SECTION`, `STUD_COURSE`,
                                        CONCAT(`STUD_COURSE`,' ',`Stud_YEAR_LEVEL`,'-',`STUD_SECTION`) AS COURSE,
                                        `Stud_CITY_ADDRESS`,`Stud_MOBILE_NO`,`STUD_EMAIL` FROM r_stud_profile where stud_no = '$stud_no'";
                    ...
                    ?>
                                            ...
                                            <div class="form-group" style="display:none">
                                                <input type="text" class="form-control" name="_yr" value="<?php echo $row['Stud_YEAR_LEVEL']?>"> </div>
                                            <div class="form-group" style="display:none">
                                            ...
                                            <div class="form-group" style="display:none">
                                                <input type="text" class="form-control" name="_add" value="<?php echo$row['Stud_CITY_ADDRESS']?>"> </div>
                                            <div class="form-group" style="display:none">
                                                <input type="text" class="form-control" name="_cno" value="<?php echo$row['Stud_MOBILE_NO']?>"> </div>
                                <div style="text-align:center">
                                <button data-toggle="modal" name="insert" class="btnInsert btn btn-primary" data-target="#Continue" type="submit">Save</button>
...
include('config.php');
  ...
  $sql= "SELECT  t.Couns_ID, t.Couns_CODE, t.STUD_ID, t.STUD_NO, t.STUD_NAME, t.STUD_COURSE, t.STUD_YR, t.STUD_SECTION, 
              t.STUD_CONTACT, t.STUD_EMAIL, t.Stud_CITY_ADDRESS, t.COUNS_APPROACH, t.COUNS_BG, t.COUNS_GOALS, t.COUNS_PREV_TEST, t.COUNS_PREV_PERSON, 
